            ...
            <!-- <fieldset disabled>
                ...
                <div class="form-group">
                    ...
                    <div class="col-12">
                        ...
                        <input type="checkbox" name="cek[]" value="Room Service$20"><label for="roomservice">Room Service</label>
                    </div>
                    <div class="col-12">
                        <input type="checkbox" name="cek[]" value="Breakfast$20"><label for="breakfast">Breakfast</label>
                    </div>
                </div>
